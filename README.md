...
Предварительная обработка датасета в папке Code

Применение алгоритмов машинного обучения. В качестве моделей машинного обучения были выбраны Ridge, RandomForestRegressor, GradientBoostingRegressor и MLPRegressor.
